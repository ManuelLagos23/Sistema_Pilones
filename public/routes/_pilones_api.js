...
router.post('/', async (req, res) => {
    try {
        const { nombre, finca, variedad, corte, clase, cosecha, empilonado, etapa, tipo_tabaco, pn, temp_min, temp_max, estado, proceso } = req.body;



        await pilonesController.createPilon(nombre, finca, variedad, corte, clase, cosecha, empilonado, etapa, tipo_tabaco, pn, temp_min, temp_max, estado, proceso);
...
router.put('/:pilonId', async (req, res) => {
    try {
        const pilonId = req.params.pilonId;
        const { nombre, finca, variedad, corte, clase, cosecha, etapa, tipo_tabaco, pn, temp_min, temp_max, estado, empilonado, proceso } = req.body;

        await pilonesController.updatePilones(pilonId, nombre, finca, variedad, corte, clase, cosecha, etapa, tipo_tabaco, pn, temp_min, temp_max, estado, empilonado, proceso);
